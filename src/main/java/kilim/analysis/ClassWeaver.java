...
public class ClassWeaver
{
    ...
    public ClassWeaver(InputStream is, Detector detector)
            throws IOException
    {
        this(is, detector, Thread.currentThread().getContextClassLoader());
    }

    public ClassWeaver(String className, Detector detector)
            throws IOException
    {
    ...
    public ClassWeaver(InputStream is, Detector detector, ClassLoader classLoader)
            throws IOException
    {
        this.detector = detector;
        this.classLoader = classLoader;
    ...
    public ClassWeaver(String className, Detector detector, ClassLoader classLoader)
            throws IOException
    {
