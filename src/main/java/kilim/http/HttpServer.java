...
public class HttpServer
{
    ...
    public HttpServer(int port, SessionFactory factory)
            throws IOException
    {
        nio = new NioSelectorScheduler();
    ...
    public HttpServer(int port, HttpSession.StringRouter handler)
            throws IOException
    {
        nio = new NioSelectorScheduler();
    ...
    public void listen(int port, SessionFactory factory, Scheduler httpSessionScheduler)
            throws IOException
    {
