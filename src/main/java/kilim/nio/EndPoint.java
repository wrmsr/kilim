...
{ // Mailbox for receiving socket ready events.
     ...
     * @throws IOException
     */
    public ByteBuffer fill(ByteBuffer buf, int atleastN)
            throws IOException, Pausable
    {
     ...
     * @throws Pausable
     */
    public ByteBuffer fillMessage(ByteBuffer bb, int lengthLength, boolean lengthIncludesItself)
            throws IOException, Pausable
    {
        int pos = bb.position();
     ...
     * @throws Pausable
     */
    public void write(FileChannel fc, long start, long length)
            throws IOException, Pausable
    {
        SocketChannel ch = dataChannel();
