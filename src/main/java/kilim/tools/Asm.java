...
import static kilim.Constants.ACC_ENUM;
import static kilim.Constants.ACC_FINAL;
import static kilim.Constants.ACC_INTERFACE;
import static kilim.Constants.ACC_NATIVE;
import static kilim.Constants.ACC_PRIVATE;
import static kilim.Constants.ACC_PROTECTED;
import static kilim.Constants.ACC_PUBLIC;
import static kilim.Constants.ACC_STATIC;
import static kilim.Constants.ACC_STRICT;
import static kilim.Constants.ACC_SUPER;
import static kilim.Constants.ACC_SYNCHRONIZED;
import static kilim.Constants.ACC_TRANSIENT;
import static kilim.Constants.ACC_VOLATILE;
import static kilim.Constants.D_DOUBLE;
import static kilim.Constants.D_LONG;
import static kilim.Constants.LDC2_W;
import static kilim.Constants.NEWARRAY;
import static kilim.Constants.T_BOOLEAN;
import static kilim.Constants.T_BYTE;
import static kilim.Constants.T_CHAR;
import static kilim.Constants.T_DOUBLE;
import static kilim.Constants.T_FLOAT;
import static kilim.Constants.T_INT;
import static kilim.Constants.T_LONG;
import static kilim.Constants.T_SHORT;
import static kilim.Constants.V1_5;
import static kilim.Constants.V1_6;
