...
public class Weaver
{
    ...
    static void weaveFile(String name, InputStream is, Detector detector)
            throws IOException
    {
        try {
     ...
     */
    public static void weaveClass2(String name, Detector detector)
            throws IOException
    {
        try {
            ClassWeaver cw = new ClassWeaver(name, detector);
     ...
     */
    public List<ClassInfo> weave(ClassInfo cl)
     ...
     * @throws KilimException
     */
    public List<ClassInfo> weave(List<ClassInfo> classes)
            throws KilimException
    {
