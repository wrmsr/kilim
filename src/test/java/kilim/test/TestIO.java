        ...
        extends TestCase
{
     ...
     */
    static void send(SocketChannel sc, String s)
            throws IOException
    {
     ...
     */
    static String rcv(SocketChannel sc)
            throws IOException
    {
        // rcv
     ...
     * @throws IOException
     */
    public void testParallelEchoes()
            throws IOException
    {
        try {
    ...
    public void sendChunkWithDelay(OutputStream os, byte[] sendbuf, int offset, int len)
            throws IOException
    {
