        ...
        extends ExYieldBase
{
    ...
    static long fact_st(long n, boolean doPause)
            throws Pausable
    {
//        System.out.println("n = " + n + ", doPause = " + doPause);
    ...
    static float pausable_st(int i, boolean doPause)
            throws Pausable
    {
        if (doPause) {
            Task.sleep(50);
    ...
    long fact_av(long n, boolean doPause)
            throws Pausable
    {
        if (n == 1) {
            if (doPause) {
